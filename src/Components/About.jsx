      ...
      <div className="first-bg">
        <div className="first-bg-anim">
          <div className="about-content about-me">
            <p>
              At a young age, I found a passion for creating things in the form
              of Star Wars Legos and as I grew, that passion grew with me which
              lead me to become a Software Engineer.
            </p>
            <p>
              May the force be with you! <i className="fa-solid fa-jedi"></i>
            </p>
          </div>
