    ...
    <div className="container">
          ...
          <div className= "skill-content" >  
            ...
            <div className='front-end' data-aos="fade-up" >
              ...
              <Icons icon={<img src="https://upload.wikimedia.org/wikipedia/commons/6/6a/JavaScript-logo.png"  alt='javascript' width={95}/>} text="Javascript"/>
            ...
            <div className='back-end' data-aos="fade-up">
              ...
              <Icons icon={<img src="https://i.gyazo.com/86d094071fcf6848940b02a89f6fb2b3.png" alt='djangoRF' width={130}/>}  text="Django Rest"/>
              ...
              <Icons icon={<img src="https://i.gyazo.com/a9726507548eef637311b50621c9b5bf.png" alt='postgres' className="postgres-icon" width={85}/> } text="Postgres"/>
              <Icons icon={<img src="https://i.gyazo.com/f6ab376de47fb84be8fd030da6ee12ea.png" alt='MongoDB' width={100}/> } text="MongoDB"/>
            </div>
            <h3><u>Other</u></h3>
            <div className='other' data-aos="fade-up">
              <Icons icon={<img src="https://i.gyazo.com/9ae7d0c2a37c4626d2ea58f615906814.png" alt='python' width={100}/> } text="Python"/>
